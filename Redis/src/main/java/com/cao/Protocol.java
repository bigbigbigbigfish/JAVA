...
import com.cao.exceptions.RemoteException;
...
public class Protocol {
    ...
    public static Object read(InputStream is) throws RemoteException {
        return process(is);
    }
    ...
    public static Command readCommand(InputStream is) throws Exception {
        ...
        String className =String.format("com.cao.commands.%sCommand",commandName.toUpperCase());
